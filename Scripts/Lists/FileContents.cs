...
public static class FileContents
{
    ...
    [
        ...
        "go listen to the pleasure principle",
        "go listen to absolution",
        "go listen to short bus",
        "go listen to rat wars",
        "go listen to welcome oblivion",
        "here in my car, i feel safest of all",
        "you say too late to start, got your heart in a headlock",
        "i call me, sweet alibi",
        ...
        "you desecrate the things that you don't understand, come catch me if you can",
        "did you think you were cool?",
        "so cool",
        "hey my children, what seems important won't last forever",
        "rush in with your dogs, clear out the cobblestone",
        "go listen to loksmith",
        "go play psychonauts 2",
        "go play psychopomp gold",
        ...
        "welcome oblivion",
        "the beginning is the end, and it keeps coming around again",
        ...
        "all i can do, driving me through, into you",
        ...
        "et quand le jour arrive, map toune le ciel, et map toune la mer, et la mer ve embrasse moi, et delivre moi lakay, an rien peut arreter moi konin la",
        ...
        "you're free to die, i'm not going to stop you",
        "through every forest, above the trees, within my stomach, scraped off my knees",
        "same as it ever was",
        "lettin' the days go by, let the water hold me down",
        "and i am the willing victim of a cannibal",
        "you understand mechanical hands are the ruler of everything",
        "it's never to late to re-invent the bicycle",
        "this ballgame's in the refridgerator, the door is closed, the lights are out, and the butter's getting hard",
        ...
        "war is overdue, the time has come for you to shoot your leaders down", // true...
        "aim, shoot, kill your leaders, aim, kill them all", // TRUE...
        "hey can you go give me a reason to listen to hey man nice shot, just like find that orange idiot and actually hit your target unlike the last guy",
        "kill the president",
        "wild and bereft, assassin is born",
        "amortise, downsize, lay off",
        "what a pathetic string of words",
        "i don't believe it, i had to see it, i came back haunted",
        "i think i may have even listened to you, at the height of my demise",
        "breath, breathe, breathe, break through the surface and breathe",
        "i am forgiven, i am free, i am a field on fire",
        "i tried to get so high, i made it ten miles high",
        "all i do i can still feel you",
        "underneath it all, we feel so small",
        "the heavens fall, but still we crawl",
        "he couldn't believe how easy it was",
        "iwouldnevertellyouanythingthatwasntabsolutelytruethathadntcomerightfromhismouthandhewantsmetotellyou",
        "iamtryingtobelieve",
        "we think we climb so high, up all the backs we've condemned",
        "and when you return to the place that you call home, we will be there. we will be there.",
        ...
        "everything is right on track, we are letting you get away",
        "you will never, ever, ever get to me in here",
        "so what are you waiting for?",
        "did it fix what was wrong with you?",
        "are you <?",
        "go and look what you've gone done, come on, welcome oblivion",
